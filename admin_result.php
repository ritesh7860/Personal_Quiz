...
<body>
    <div class="layout flex flex-col xl:flex-row-reverse">

        <!-- Graph -->

        <div class="chart-section h-[50%]">
            <h3 class="font-semibold">📊 Average Scores by Technology</h3>
            <canvas id="techChart" class="text-center"></canvas>
        </div>

        <!-- Table -->
        <div class="table-section px-4 w-[96%] xl:w-[70%]">
            <div class="filter-bar pb-2 flex justify-between items-center py-4">
                <div>
                    <h1 class="text-2xl font-semibold tracking-wide">Results</h1>
                </div>
                <form method="get" action="" class="flex items-center gap-2">
                    <label for="tech" class="font-semibold hidden md:block">Filter by Technology:</label>
