...
<body class="bg-gray-200">
    <div class="main flex h-[80vh] mt-[50px] flex-col items-center">
        <div class="heading py-4">
            <h3 class="text-[1.5rem] font-semibold tracking-wide"> Edit User </h3>
        </div>
        <?php if ($user): ?>
            <form class=" w-[90%] md:w-[50%] xl:w-[30%] form p-4 bg-white shadow-xl rounded-md" align="center" method="post" name="frm" onsubmit="return f()">
                <div class="flex flex-col gap-3 p-2">
                    <div class="flex flex-col pt-2">
                        ...
                        <input class="px-4 py-2 text-sm rounded-md focus:ring-1 outline-none border border-gray-300"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input class="px-4 py-2 rounded-md text-sm border border-gray-300 bg-gray-100 cursor-not-allowed"
                            type="text" value="<?= htmlspecialchars($user['email']) ?>" disabled />
                    </div>

                    <div class="flex flex-col relative">
                        <label class="text-start text-sm font-medium">New Password (optional):</label>
                        <input class="px-4 py-2 rounded-md text-sm focus:ring-1 outline-none border border-gray-300"
                    ...
                    <div>
                        <input class="bg-[#191c5c] text-white cursor-pointer font-medium px-[10%] rounded-md py-2 transition-all hover:scale-103 duration-500 hover:shadow-xl"
