...
INSERT INTO `technologies` (`id`, `tech_name`, `description`, `created_at`) VALUES
(1, 'C', 'C is a powerful, procedural programming language known for its efficiency and low-level memory access. Developed at Bell Labs in the 1970s, it is widely used for operating systems and embedded systems.', '2025-09-27 09:00:43'),
(3, 'PHP', 'PHP is an open-source, server-side scripting language primarily used for web development. PHP code is executed on a server to generate dynamic web content, which is then delivered to the client\'s browser as plain HTML.', '2025-09-27 09:52:11'),
(4, 'Python', 'Python is a versatile, high-level, and interpreted programming language known for its clear, readable syntax. It is widely used in areas like web development, data science, and automation, and is popular for its extensive libraries and ease of use for beginners.', '2025-09-27 09:53:38'),
(5, 'Java', 'Java is a class-based, object-oriented programming language designed for platform independence with its \"Write Once, Run Anywhere\" philosophy. It is widely used for building everything from enterprise software and mobile apps to large-scale data applications.', '2025-09-27 09:54:44'),
(6, 'HTML', 'HTML (HyperText Markup Language) is the standard markup language used to create and structure content on the web. It uses a series of elements and tags to tell a web browser how to display text, images, and other multimedia.', '2025-09-27 10:00:02');
